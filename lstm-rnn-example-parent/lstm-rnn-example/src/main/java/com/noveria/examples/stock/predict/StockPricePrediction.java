package com.noveria.examples.stock.predict;

import com.noveria.examples.stock.model.RecurrentNets;
import com.noveria.examples.stock.representation.PriceCategory;
import com.noveria.examples.stock.representation.StockDataSetIterator;
import com.noveria.examples.stock.utils.PlotUtil;
...
public class StockPricePrediction {
    ...
    public static void main (String[] args) throws IOException {
        ...
        String outputLocation = new ClassPathResource("stockPrediction").getFile().getAbsolutePath();
        File locationToSave = new File(outputLocation+"/StockPriceLSTM_".concat(String.valueOf(category)).concat(".zip"));
